...
namespace Fullscreen {
    ...
    public static class FullscreenUtility {
        ...
        private const string TEMP_LAYOUT_PATH = "Library/FullscreenTempLayout.dwlt";
        private const string SAFE_LAYOUT_PATH = "Library/FullscreenSafeLayout.dwlt";
        ...
        //    WaitFrames(3, () => {
        //        if(all.Length == 0 && File.Exists(SAFE_LAYOUT_PATH)) {
        //            LoadLayout(true);
